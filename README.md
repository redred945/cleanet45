...
- **Source photos** : page Facebook publique [facebook.com/Cleanet45](https://www.facebook.com/Cleanet45/) (795 abonnés au 2026-09-22, Orléans, 07 83 39 28 18, Cleanet45@gmail.com, prix `€€`) — 5 photos réelles du client téléchargées dans `assets/img/gallery/` et utilisées en fond de hero + galerie "Réalisations" : `car-exterior-1.jpg` (Range Rover Sport), `cuir-interieur-1.jpg` (sièges cuir), `camion-cabine-1.jpg` (cabine poids lourd), `canape-1.jpg` / `canape-2.jpg` (canapé d'angle, post "avant/après" du 14/09).
...
- [ ] Confirmer avec le client l'usage de ses photos Facebook sur le site (probable mais à valider explicitement) et récupérer si possible des originaux en meilleure résolution / plus variés (moquette, phares, diagnostic électronique n'ont aucune photo actuellement)
